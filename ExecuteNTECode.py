...
DepartureDateString = "2018-10-06"
ReturnDateString = "2018-10-14"
#filetoload = "\ResultFiles\InputFile.csv"
filetoload = "\ResultFiles\InputFile-BusinessClass.csv"
...
GenerateReverseInd = "N" #This will get the reverse for the One way Fare. For example, if going to DCA to IND it will get IND to DCA.
DaysToTry = 5 #It will increment the date up to this many times if the code does not find a fare.
HoursBtwnMinFlight = 2 #This was .5. Use will disregard itineraries that exceed the most direct route by this many hours 
